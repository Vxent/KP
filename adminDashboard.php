...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <script>
// Assuming you have already passed the daily orders data to JavaScript
var dailyOrders = <?php echo json_encode($dailyOrders); ?>; // Fetch from PHP
var days = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']; // Day labels
